    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{route('customers.fuel-quotas-requests')}}">Fuel Token Requests</a></li>
            <li class="breadcrumb-item active">New Fuel Request</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
              ...
              <div class="card-body">
                <form method="post" action="{{ route('customer.request-fuel') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.1" class="form-control" id="liters_required" name="liters_required" placeholder="Enter liters required" required min="0" max="25000">
                    </div>
                    <br>
                    <div class="form-group">
