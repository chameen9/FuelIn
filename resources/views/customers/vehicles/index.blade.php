    ...
    <section class="section dashboard">
                ...
                <div class="card" style="padding: 20px;">
                    <div class="card-body">
                        <div class="d-grid gap-0 col-12 mx-auto">
                            <br>
                            <a href="{{ route('customers.vehicles.create') }}" class="btn btn-primary btn-md">Add New</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            @foreach ($vehicles as $vehicle)
                <div class="col-lg-6 col-xl-6 col-md-6 col-sm-6">
                    <div class="card" style="padding: 20px;">
                        <h3 class="card-title">{{ $vehicle->registration_number }}<span> | {{ $vehicle->Type_Name }}</span></h3>
                        <div class="card-body">
