...
<head>
  ...
  <title>FuelIn | Fuel Token Requests</title>
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Fuel Token Requests</h1>
      <nav>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{route('customer_dashboard')}}">Home</a></li>
            <li class="breadcrumb-item active">Fuel Token Requests</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
            ...
            <div class="card" style="padding: 20px;">
                <div class="card-body">
                    <div class="d-grid gap-0 col-12 mx-auto">
                        <br>
                        <a href="{{ route('customer.show-fuel-request-form') }}" class="btn btn-primary btn-md">New Fuel Request</a>
                    </div>
                </div>
            </div>
          </div>
                  ...
                  <tbody>
                    @foreach ($fuelRequests as $request)
                      <tr>
                       ...
                       <form action="{{ route('qrcode.view', $request->token_id) }}" method="POST">
                          @csrf
                          <input type="hidden" name="token_id" id="token_id" value="{{$request->token_id}}"/>
                          <input type="submit" class="btn btn-success btn-sm" value="View Token"/>
                        </form> 
